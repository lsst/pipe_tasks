        ...
        try:
            ...
            for i, exposure in enumerate((
                ...
                if i == 0:
                    ...
                    self.assertAlmostEqual(bgMean, 327.73842265032033, places=7)
                    self.assertAlmostEqual(bgStdDev, 0.4652636733152099, places=7)
                    ...
                    self.assertAlmostEqual(psfIyy, 2.089374882348153, places=7)
                    self.assertAlmostEqual(psfIxy,  -0.07645803963971413, places=7)
                else:
