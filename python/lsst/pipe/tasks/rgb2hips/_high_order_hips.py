    ...
    def run(self, input_images: Iterable[tuple[NDArray, SkyWcs, Box2I]], healpix_id) -> Struct:
        ...
        for input_image, in_wcs, in_box in input_images:
            ...
            for channel in ColorChannel:
                ...
                existing_non_zero = (existing[warpped_box_slices] != 0) * ~np.isnan(
                    existing[warpped_box_slices]
                )
                new_non_zero = warpped.array != 0
                ...
                existing[warpped_box_slices][are_warpped * ~both_populated] = warpped.array[
                    are_warpped * ~both_populated
                ]
