...
distortionRegistry = pexConfig.makeRegistry(
    '''A registry of distortion factories
    
       A distortion factory makes a class with the following API:
...
distortionRegistry.register("null", NullDistortion)
