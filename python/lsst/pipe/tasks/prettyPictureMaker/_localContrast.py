...
def levelPadder(numb: int, levels: int) -> list[int]:
    ...
    one to ensure the level is divisible by two.
...
def localContrast(
    ...
    # Determine the maximum level over which the image will be enhanced
