...
class BrightStarCutoutTask(PipelineTask):
    ...
    def _get_bright_stars(
        ...
        self.log.info(
            "Identified %i of %i reference catalog star%s that are in the field of view, are in the "
    ...
    def _get_bright_star_stamps(
        ...
        visit : `int`, optional
            The visit number stored in the output `BrightStarStamp`metadata.
