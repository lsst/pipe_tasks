...
class SubtractBrightStarsTask(PipelineTask):
    ...
    def createAnnulus(self, brightStarStamp):
        ...
        These radii describe the annulus where the flux of the star is found.
    ...
    def findPsfAnnularFlux(self, brightStarStamp, maskedModel):
        """Find the annular flux of the PSF model within a specified annulus.
    ...
    def preparePlaneModelStamp(self, brightStarStamp):
        ...
        It is called PlaneModel because, while it is a PSF model stamp that is
        warped and rotated to the same orientation of a chosen star, it is not
        yet scaled to the brightness level of the star.
