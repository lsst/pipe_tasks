...
class WriteSourceTableConfig(pipeBase.PipelineTaskConfig,
    ...
    doApplyExternalPhotoCalib = pexConfig.Field(
        ...
        deprecated="This field is no longer used. Use WriteRecalibratedSourceTableTask instead."
    )
    ...
    def validate(self):
        super().validate()
        if self.doApplyExternalSkyWcs or self.doApplyExternalPhotoCalib:
            raise ValueError(f"doApplyExternalSkyWcs={self.doApplyExternalSkyWcs} and "
                             f"doApplyExternalPhotoCalib={self.doApplyExternalPhotoCalib}. "
                             "These config parameters are no-ops for WriteSourceTableTask. "
                             "Set to False or use WriteRecalibratedSourceTableTask instead. ")
